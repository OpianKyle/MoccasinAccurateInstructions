  ...
  return (
    <div className="grain min-h-[100dvh] bg-[var(--paper)]">
      ...
      <main id="top">
        ...
        <section id="method" className="method-section relative overflow-hidden bg-[var(--paper)] py-24 lg:py-36">
          <div className="section-image-backdrop method-backdrop" aria-hidden="true"><img src="/stagemaster-method-notes.png" alt="" /></div>
          <div className="relative z-10 mx-auto grid max-w-[1380px] items-center gap-16 px-6 lg:grid-cols-[.9fr_1.1fr] lg:gap-24 lg:px-12">
        ...
        <section id="inside" className="inside-section bg-[#e9edf1] py-24 lg:py-36">
          <div className="mx-auto max-w-[1380px] px-6 lg:px-12">
            <div className="reveal grid gap-8 border-b border-[var(--line)] pb-10 lg:grid-cols-[1fr_.72fr] lg:items-end">
              ...
              <div className="inside-visual relative min-h-[190px] overflow-hidden">
                <img src="/stagemaster-course-rehearsal.png" alt="Speaker practicing in a recording studio" className="absolute inset-0 h-full w-full object-cover object-[60%_48%]" />
                <div className="absolute inset-0 bg-gradient-to-r from-[var(--navy)]/80 via-[var(--navy)]/20 to-transparent" />
                <p className="absolute bottom-5 left-5 max-w-[180px] text-[10px] font-bold uppercase leading-5 tracking-[.2em] text-white">Practice before the room is watching</p>
              </div>
              <p className="max-w-xs text-sm leading-6 text-slate-600 lg:col-start-1">Short, focused lessons you can put into practice before your next post, pitch or presentation.</p>
            </div>
            <div className="mt-3">
        ...
        <section className="quote-section relative overflow-hidden bg-[var(--gold)] py-20">
          <img src="/stagemaster-auditorium.png" alt="" aria-hidden="true" className="quote-backdrop absolute inset-0 h-full w-full object-cover" />
          <div className="quote-wash absolute inset-0" aria-hidden="true" />
          <div className="absolute -right-20 -top-32 text-[260px] font-black leading-none text-white/10">“</div>
          <div className="relative z-10 mx-auto grid max-w-[1380px] gap-10 px-6 lg:grid-cols-[.7fr_1.3fr] lg:items-center lg:px-12">
        ...
        <section id="pricing" className="pricing-section relative overflow-hidden bg-[var(--navy)] py-24 text-white lg:py-36">
          <div className="section-image-backdrop pricing-backdrop" aria-hidden="true"><img src="/stagemaster-course-access.png" alt="" /></div>
        ...
        <section className="faq-section relative overflow-hidden bg-[var(--paper)] py-24 lg:py-32">
          <div className="mx-auto grid max-w-[1000px] gap-14 px-6 lg:grid-cols-[.75fr_1.25fr] lg:px-12">
            <div className="reveal"><p className="text-[10px] font-bold uppercase tracking-[.26em] text-[var(--blue)]">Questions, answered</p><h2 className="mt-5 text-4xl font-extrabold leading-[1.04] sm:text-5xl">Before you take the mic.</h2><div className="faq-visual relative mt-9 aspect-[4/3] max-w-sm overflow-hidden"><img src="/stagemaster-backstage.png" alt="Speaker preparing backstage before a talk" className="h-full w-full object-cover object-center" /><div className="absolute inset-0 bg-gradient-to-t from-[var(--navy)]/65 to-transparent" /><p className="absolute bottom-4 left-4 text-[9px] font-bold uppercase tracking-[.18em] text-white">You already have something to say</p></div></div>
            <div className="reveal reveal-delay-1">
        ...
        <section className="cta-section relative overflow-hidden bg-[var(--blue)] py-24 text-white lg:py-32">
          <img src="/stagemaster-final-stage.png" alt="" aria-hidden="true" className="cta-backdrop absolute inset-0 h-full w-full object-cover object-[68%_center]" />
          <div className="cta-wash absolute inset-0" aria-hidden="true" />
      ...
      <footer className="footer-section bg-[var(--navy)] px-6 py-8 text-white lg:px-12">
